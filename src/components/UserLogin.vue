    ...
    <!-- Card -->
      <div class="card h-100 login-card">
        <div class="card-header bg-dark text-white">
           <i class="fa-solid fa-user-lock"></i> Login Page
        </div>
        <div class="card-body">
          <h4 class="card-title"> Please fill in your credentials</h4>
        ...
        <div class="card-footer text-muted">
          <router-link to="/register" class="nav-link">
           <i class="fa-solid fa-user-plus"></i> Don't have an account? Please register
          </router-link>
  </div>
      </div>
    <!-- /Card -->
